...
import Admin_Line_Chart from "../../Components/Chart/AdminLineChart";
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchRecentCompanyData = async () => {
      try {
        const response = await axios.get("/data/recentCompany.json");
            ...
            <div className="flex flex-col sm:flex-row gap-1 lg:gap-5 mb-5">
              ...
              <div className="flex gap-5 flex-wrap rounded-lg bg-secondary-color py-2 px-1 lg:p-5 items-center justify-center flex-1">
                <div className="flex gap-2 xl:gap-4 items-center">
                  <img src={AllIcons.company} className="h-14 w-14" alt="" />

                  <div className=" w-fit text-center">
                    <p className="text-sm lg:text-base xl:text-xl font-medium text-primary-color">
                      124
                    </p>
                    <p className="text-xs lg:text-base xl:text-lg text-primary-color mb-1">
                      Companies
                    </p>
                  </div>
                </div>
              ...
              {/* Service User  */}
              <div className="flex gap-5 flex-wrap rounded-lg bg-[#326471] py-2 px-1 xl:p-5 items-center justify-center flex-1">
            ...
            <div className=" mt-10 rounded">
              <div className="bg-[#FFFFFF] rounded flex-1">
                <div className="flex justify-between items-center mx-3 py-2">
                  <p className="text-2xl mb-2 font-bold text-[#1D242D]">
                    Recent Added Company
                  </p>
                </div>
